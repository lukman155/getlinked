...
<nav>
	<a class="logo" href="/" title="homepage">get<span>linked</span></a>
...
<aside class="menu" class:open>
	<button class="close-button" on:click={() => (open = !open)}>
